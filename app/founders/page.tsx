  ...
  return (
    <>
      ...
      <p>
        ...
        calls on those who see nation-building as long-term legacy work. This invitation
        is for those ready to act before success is guaranteed. Founding institutions are
        not donors or spectators &mdash; they are builders of credibility, capability, and
      ...
      <div className="founders-section">
        ...
        <p>
          We&rsquo;re seeking institutions, and individuals acting through institutions,
          with the capacity to turn vision into structure &mdash; across legal, financial,
          institutional, diplomatic, or cultural domains.
        </p>
        <p>
          Whether a contribution is visible or discreet, what matters is that it moves
          the project forward in a real, measurable way.
        </p>
        <p>
        ...
        <p>
          Recognition as a Founding Institution is not transactional &mdash; it is earned.
        </p>
        <p>
          Institutions that make meaningful contributions during the city&rsquo;s formative
          stage may be recognized as Founding Institutions of Sainte-Patrie. Their
          contribution is recorded in the Founding Institutions Registry, the public
          historical record documenting those who helped establish the commune.
        </p>
        <p>
          Recognition acknowledges the role an institution played in helping bring
          Sainte-Patrie into existence. It does not confer governing authority,
        ...
        <ul className="bullet-list">
          ...
          <li>Invitations to civic commemorations and major milestones related to the founding of Sainte-Patrie</li>
        </ul>
        <p>
          These recognitions exist to acknowledge contribution and preserve the history
          of the city&rsquo;s creation. They do not confer governing authority, operational
        ...
        <p>
          ...
          that functions &mdash; and creating a precedent for what Haiti can demand of its future.
        </p>
        <p>
          Cities rarely emerge through government action alone. They take form through
          the efforts of individuals and institutions willing to contribute before
        ...
        <div className="intent-box">
          ...
          <ul className="bullet-list">
            ...
            <li>Why this mission speaks to it</li>
          </ul>
          <p>
