...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Where will Sainte-Patrie be located?', acceptedAnswer: { '@type': 'Answer', text: "The city is planned for the northeast of Haiti, in the Grand Nord, a region with real assets in tourism potential and proximity to Atlantic trade routes. The goal is to strengthen the region's capacity to attract private investment, expand economic opportunity, and build the institutional depth that allows growth to compound over time rather than remain concentrated in a single place." } },
